...
const ManageSidebar = () => {
  ...
  return (
    <div className={`h-[300px] rounded-xl m-1 w-[18%] bg-[#03346E] hover:shadow-md hover:shadow-blue-500 transition-all duration-300 dark:bg-slate-800 fixed top-0 left-0  font-[sans-serif] overflow-hidden`}>
